...
if ($redLight === true or $yellowLight === true){
    ...
    echo "Are you sure that the traffic lights are working at all?";
}
...
switch ($trafficLight) {
   case "Green"; 
      echo "$trafficLight: ", "Keep moving!";
      break; 	
   case "Red"; 
      echo "$trafficLight: ", "Stop the car!";
      break;
    case "Yellow";
        echo "$trafficLight: ", "Stop the Car!";
        break;
   default: echo "Use common sense and stay safe!";
}
